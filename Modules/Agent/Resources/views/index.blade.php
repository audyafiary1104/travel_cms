                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form id="register-form" action="{{route('register.agent')}}" method="post"
                                ...
                                <div class="form-group">
                                    <input type="tel" name="phone_number" id="password" tabindex="2"
                                        class="form-control" placeholder="Phone number">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="company" id="confirm-password" tabindex="2"
                                        class="form-control" placeholder="Company">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="alamat" id="confirm-password" tabindex="2"
